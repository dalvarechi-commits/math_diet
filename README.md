...
Lista de los 14 alérgenos alimentarios más comunes. (2025). Eufic.Org. https://www.eufic.org/es/vida-sana/articulo/lista-de-los-14-alergenos-alimentarios-mas-comunes/
‌
Lista de los 14 alérgenos alimentarios más comunes. (2025). Eufic.Org. https://www.eufic.org/es/vida-sana/articulo/lista-de-los-14-alergenos-alimentarios-mas-comunes/
‌
‌
Base de Datos BEDCA. (2026). Bedca.Net. https://www.bedca.net/bdpub/         (Para la memoria: Hemos modificado las categorías que proporciona Bedca para agrupar los alimentos en categorías que nos resultan más útiles para el grafo por simplificar el algoritmo, los hemos agrupado por el macronutriente principal)
‌
